...
void BOLIDE_Player::readPose(){
    ...
    for(int i=0;i<poseSize;i++){
        ...
        Serial.print( i);
        Serial.print( ":");
        Serial.println( pose_[i] >> A1_16_SHIFT);
    }
    Serial.println("end read pos");
}
...
/* play a sequence. */
void BOLIDE_Player::playSeq( const transition_t_b  * addr ){
    sequence = (transition_t_b *) addr;
